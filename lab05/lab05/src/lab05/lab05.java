...
public class lab05 extends Application {
    ...
    private final ObservableList<StudentRecord> marks  =
            ...
            new StudentRecord("100100101", 70.0f, 69.25f, 51.5f),
            new StudentRecord("100100102", 100.0f, 97.0f, 92.5f),
            new StudentRecord("100100103", 90.0f, 88.5f, 68.75f),
            new StudentRecord("100100104", 72.25f, 74.75f, 58.25f),
            new StudentRecord("100100105", 85.0f, 56.0f, 62.5f),
            new StudentRecord("100100106", 70.0f, 66.5f, 61.75f),
            new StudentRecord("100100107", 55.0f, 47.0f, 50.5f),
            new StudentRecord("100100108", 40.0f, 32.5f, 27.75f),
            new StudentRecord("100100109", 82.5f, 77.0f, 74.25f)); 
    //--------------
        ...
        addButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                marks.add(new StudentRecord(
                        addSID.getText(),
                        Float.parseFloat(addAssignment.getText()),
                        Float.parseFloat(addMidterm.getText()),
                        Float.parseFloat(addExam.getText())
                        ));
                addSID.clear();
                addAssignment.clear();
                addMidterm.clear();
